...
import org.federicopastore.businessprocessanalyzer.parser.elements.model.BlockActivity;
...
import org.federicopastore.businessprocessanalyzer.parser.elements.model.Route;
	...
	private void checkForImplementation() {
		...
		if (implElem != null) {
			...
			case "Task":
				...
				case "TaskUser":
					...
					impl = new ImplementationImpl(
							...
							org.federicopastore.businessprocessanalyzer.parser.xpdl.enums.ImplementationType.Task);
					break;
				case "TaskService":
					impl = new ImplementationImpl(
			...
			case "SubFlow":
				...
				impl = new ImplementationImpl(subflow, org.federicopastore.businessprocessanalyzer.parser.xpdl.enums.ImplementationType.SubFlow);
				break;
			default:
				break;
			}
